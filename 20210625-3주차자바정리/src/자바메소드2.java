...
public class 자바메소드2 {
	...
	public static void main(String[] args) {
		...
		int[] arr = {1,2,3,4,5};
		int[] aaa = arr; // 벌집 => aaa.ar ==> Call by Reference , 배열 , 클래스 (단 예외 : String)

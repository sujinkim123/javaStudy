 ...
 *     자바 / MFC(계열)
 *     ====
 *     1995 => 1996 (우리나라) ===> 부상 20000년 (전자상거래:자바) : 만들어 보관 => 재사용
 */
class Category {
	int no; // 카테고리 번호
	String title; // 제목
	String subject; // 부제목
	// 서로 다른 데이터형 모아서 관리 (사용자 정의 데이터형)
	/*
	 * 1. 기본 데이터형 
	 ...
	 *                    ================ 
	 *                    객체 지향 3대 요소 
	 *                    1) 재사용 = 필요시 수정해서 사용 (상속: is-a) =========> 재사용성= 있는 그대로 (포함: has-a) 
	 *                    2) 데이터의 중요성 => 데이터 보호 (캡슐화) 
	 *                    3) 수정,추가가 가능하게 만들어진다 (다형성) ===> 관리 용이 
	 *                    4) 이미 완성된 제품을 사용 ==> 신뢰성이 높다
	 *                     ============================================= 유지보수 
	 *                     클래스의 종류 , 클래스 접근 범위 ... (공개 , 해당 클래스에서 사용, 같은 폴더에서 접근 상속시 접근) 
	 *                     => 추상클래스 
	 *                     => 인터페이스 
	 ...
	 *                     ================================================================ 
	 *                     사용자가 오류 : 프로그램 유지 => 오류방지 (예외처리) ==> 6,7,8장
	 * 
	 */
}
...
public class 자바메소드4 {
	...
	// 클래스 제작 => 기본 데이터형과 동일 (형변환, 배열)
	/*
	 * <div class ="info_inner_wrap"> <span class="title">비빔밥 맛집 베스트 25곳</span> <p
	 * class="desc">"밥은 비벼야 제맛이지!"</p>
	 */

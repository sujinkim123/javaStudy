 ...
 *     ========================================================================================================
 *      ***인스턴스 변수    => 객체 생성                 프로그램 종료시    클래스 전체 영역에서 사용 가능
 *                             new
 *     ========================================================================================================
 *      정적변수(공유변수)  => 컴파일러가 class 파일을   프로그램 종료시   클래스 
 *      전체 영역에서 사용 가능
 *                             로드했을 경우 (java)
 *                        a.java ==== a.class ==== 실행
 *                               javac        java     
 *     ========================================================================================================
 *      ***지역변수         => 메소드 호출시마다          메소드가 종료하면          메소드 영역에서만
 *                                                        자동으로 사라진다            사용이 가능
 *     ========================================================================================================
 *     
 *     인스턴스 변수
 ...
 *         데이터형 변수명;
 *         데이터형 변수명;
 *         static 데이터형 변수명; // 전역변수 => 클래스 전체에서 사용 , 멤버변수
 *         
 ...
 *         String name; ===> heap
 *         void Print() {
 *             String anme = "박문수"; ===> stack  ==> 지역변수 우선순위 => 멤버변수
 ...
 *                  정수형, 실수형, 논리형, 문자형
 *               2) 직접 데이터형을 제작한다 ==> class (사원,학생,영화,음악,맛집,레시피)
...
public class MainClass2 {
	public static void main(String[] args) {
		...
		// 메모리에 접근시마다 ==> .  m1.title (.은 주소 접근 연산자)

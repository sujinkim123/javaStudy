// page 283 오버로딩
/*
 *   오버로딩 : 중복메소드 정의 (같은 메소드 이름으로 여러개 메소드를 제작)
 *   오버로딩 (다형성)
 *     1. 한 개의 클래스 안에서 같은 이름의 메소드 여러개 정의
 *        ==============        ==================
 *     2. 매개변수가 개수나 데이터형이 다르다
 *     3. 리턴형은 관계없다
 *     
 ...
 *     void plus(int a, int b) => 오류 발생    void plus(int k, int a) ==> plus(int,int)
 *     void plus(int a)
 *     =================================================================================
